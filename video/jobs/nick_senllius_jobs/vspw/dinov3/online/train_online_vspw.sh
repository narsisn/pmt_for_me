...
srun --ntasks=2 --ntasks-per-node=1 bash -c "python train_net_video.py --num-gpus 4 --num-machines 2 \
  ...
  MODEL.WEIGHTS /projects/prjs1742/Narges/frozen_videomt/training/vspw/step2/vspw_step5/model_final.pth \
  SOLVER.IMS_PER_BATCH 8 \
  TEST.EVAL_PERIOD 40000 \
  SOLVER.MAX_ITER 40000 \
  OUTPUT_DIR /projects/prjs1742/Narges/frozen_videomt/training/vspw/step3/40k/vspw_step3_1 "
  
DATAROOT='/projects/prjs1742/Narges/datasets/VSPW_480p'
IMGSAVEROOT='/projects/prjs1742/Narges/frozen_videomt/training/vspw/step3/40k/vspw_step3_1/inference'
GT_JSONFILE='/projects/prjs1742/Narges/datasets/VSPW_480p/panoptic_gt_VSPW_val.json'
