...
srun --ntasks=2 --ntasks-per-node=1 bash -c "python train_net_video.py --num-gpus 4 --num-machines 2 \
  ...
  --config-file configs/VSPW/videomt/vit-large/videomt_segmenter_ViTL_dinov2.yaml \
  ...
  OUTPUT_DIR /projects/prjs1742/Narges/frozen_videomt/training/vspw/dinov2/step2/640/vspw_step2_1 "
  
DATAROOT='/projects/prjs1742/Narges/datasets/VSPW_480p'
GT_JSONFILE='/projects/prjs1742/Narges/frozen_videomt/training/vspw/dinov2/step2/640/vspw_step2_1/inference'
