...
srun --ntasks=2 --ntasks-per-node=1 bash -c "python train_net_video.py --num-gpus 4 --num-machines 2 \
  ...
  --config-file  configs/VIPSeg/videomt/vit-large/videomt_segmenter_ViTL_dinov2.yaml \
  MODEL.WEIGHTS  /projects/prjs1742/Narges/pre-trained_models/dinov3/dinov2/ps/640/coco_pan_vit_l_next_mf_dinov2_640_last_videomt.ckpt \
  SOLVER.IMS_PER_BATCH 8 \
  TEST.EVAL_PERIOD 40000 \
  SOLVER.MAX_ITER 40000 \
  OUTPUT_DIR /projects/prjs1742/Narges/frozen_videomt/training/vipseg/dinov2/step2/vipseg_step2_1 "
  
DATAROOT='/projects/prjs1742/Narges/datasets/VIPSeg/VIPSeg_720P/panomasksRGB'
IMGSAVEROOT='/projects/prjs1742/Narges/frozen_videomt/training/vipseg/dinov2/step2/vipseg_step2_1/inference'
