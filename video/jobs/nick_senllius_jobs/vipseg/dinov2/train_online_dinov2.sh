...
srun --ntasks=2 --ntasks-per-node=1 bash -c "python train_net_video.py --num-gpus 4 --num-machines 2 \
  ...
  MODEL.WEIGHTS  /projects/prjs1742/Narges/frozen_videomt/training/vipseg/dinov2/step2/vipseg_step2_1/model_final.pth \
  SOLVER.IMS_PER_BATCH 8 \
  TEST.EVAL_PERIOD 40000 \
  SOLVER.MAX_ITER 40000 \
  OUTPUT_DIR /projects/prjs1742/Narges/frozen_videomt/training/vipseg/dinov2/step3/vipseg_step3_1 "
  
DATAROOT='/projects/prjs1742/Narges/datasets/VIPSeg/VIPSeg_720P/panomasksRGB'
IMGSAVEROOT='/projects/prjs1742/Narges/frozen_videomt/training/vipseg/dinov2/step3/vipseg_step3_1/inference'
