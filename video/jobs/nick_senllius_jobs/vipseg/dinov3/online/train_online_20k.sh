...
srun --ntasks=2 --ntasks-per-node=1 bash -c "python train_net_video.py --num-gpus 4 --num-machines 2 \
  ...
  OUTPUT_DIR /projects/prjs1742/Narges/frozen_videomt/training/vipseg/step3/20k/vipseg_step1 "
  
DATAROOT='/projects/prjs1742/Narges/datasets/VIPSeg/VIPSeg_720P/panomasksRGB'
IMGSAVEROOT='/projects/prjs1742/Narges/frozen_videomt/training/vipseg/step3/20k/vipseg_step1/inference'
