...
def add_videomt_config(cfg):
    ...
    cfg.MODEL.BACKBONE.EXTRA_BN = True
    cfg.MODEL.BACKBONE.NUM_BLOCKS = 6
    cfg.MODEL.BACKBONE.MASKED_ATTN_ENABLED = True
    cfg.MODEL.BACKBONE.INTERACTION_INDICES = [5, 11, 17, 23]
    cfg.MODEL.BACKBONE.RESIDUAL_PROJECTION = True
    cfg.MODEL.BACKBONE.RESIDUAL_PATH = True
    cfg.MODEL.BACKBONE.LEVEL_SCALERS = True
    cfg.MODEL.BACKBONE.DECODER_PE = 'rope'
